...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { birth_date: @director.birth_date, description: @director.description, fist_name: @director.fist_name, last_name: @director.last_name } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { birth_date: @director.birth_date, description: @director.description, fist_name: @director.fist_name, last_name: @director.last_name } }
